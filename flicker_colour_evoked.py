...
np.save(file_name + '_' + electrode_name + '_all_evoked_ffts',all_ffts) # saves all original FFTs

all_lp_ffts = np.array([blue_lp_ffts,red_lp_ffts,green_lp_ffts,white_lp_ffts]) # stacks all interpolated FFTs
np.save(file_name + '_' + electrode_name + '_all_evoked_lp_ffts',all_lp_ffts) # saves all interpolated FFTs
...
np.save(file_name + '_' + electrode_name + '_all_evoked_SNR',SNR_ffts) # saves all original SNRs
