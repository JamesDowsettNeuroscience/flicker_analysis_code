...
np.save(file_name + '_' + electrode_name + '_all_induced_ffts_' + str(length_of_segment) + 's',all_ffts) # saves all original FFTs

all_lp_ffts = np.array([blue_lp_ffts,red_lp_ffts,green_lp_ffts,white_lp_ffts]) # stacks all interpolated FFTs
np.save(file_name + '_' + electrode_name + '_all_induced_lp_ffts_' + str(length_of_segment) + 's',all_lp_ffts) # saves all original FFTs
...
np.save(file_name + '_' + electrode_name + '_all_induced_SNR_' + str(length_of_segment) + 's',SNR_ffts) # saves all original SNRs
